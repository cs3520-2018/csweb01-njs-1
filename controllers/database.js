...
let DB_NAME = "csweb01";
let DB_DOMAIN = "ds047085.mlab.com:47085";
...
module.exports.storeData = async function( data )
{
 ...
 console.log('Printing checkoutInfo.billingInfo ' + checkoutInfo);
			let customerId = await insert( db, "customers", data.checkoutInfo );
			if ( customerId != null )
			{
